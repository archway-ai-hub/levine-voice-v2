...
SCENARIOS: dict[str, ScenarioConfig] = {
    ...
    "make_change": ScenarioConfig(
        transcripts=["I need to add a vehicle to my policy", "Diana Miller", "5556667777"],
    ...
    "coverage_questions": ScenarioConfig(
        transcripts=["What does my policy cover", "Eve Johnson", "5558889999"],
